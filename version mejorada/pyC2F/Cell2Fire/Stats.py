...
class Statistics(object):
    ...
    def BPHeatmap(self, WeightedScar, Path=None, nscen=10, sq=False, namePlot="BP_HeatMap"):
        ...
        # Create Heatmap
        ax = sns.heatmap(WeightedScar, center=0.0, xticklabels="auto", yticklabels="auto", 
    ...
    def GGraphGen(self, full=False):
        ...
        if full:
            for k in range(1, self._nSims + 1):
                HGraphs = nx.read_edgelist(path=self._MessagesPath + '/MessagesFile' + str(k) + '.txt',
    ...
    def GlobalFireSpreadEvo(self, CoordCells, onlyGraph=True, version=0):
        ...
        # Print nodes
        if onlyGraph == False:
            nx.draw_networkx_nodes(self._GGraph, pos = coord_pos, ax = ax,
                                   node_size = 5,
        ...
        if all_zeros is False:
            ...
            if version == 3:
                ...
                outname = "CFreq"
                nx.draw_networkx_edges(self._GGraph, pos = coord_pos, ax=ax, edge_color = weights, edge_cmap=plt.cm.Reds,
    ...
    def SimFireSpreadEvo(self, nSim, CoordCells, Colors, H=None, version=0,
        ...
        if print_graph:
            ...
            nx.draw_networkx_edges(H, pos = coord_pos, ax = ax, edge_color = 'r', width = 0.5, arrowsize=4)
    ...
    def SimFireSpreadEvoV2(self, nSim, CoordCells, Colors, H=None, version=0, onlyGraph=True):
        ...
        # Different plot versions
            ...
            if version == 1:
                nx.draw_networkx_edges(H, pos = coord_pos, ax = ax, edge_color = weights, edge_cmap=plt.cm.Reds,
    ...
    def HourlyStats(self):
        ...
        if self._CSVs:
            ...
            SummaryDF[["STDBurned", "STDHarvested"]] = Ah[["NonBurned", "Burned", "Harvested", "Hour"]].groupby('Hour')[["Burned", "Harvested"]].std()
            ...
            SummaryDF[["MaxNonBurned", "MaxBurned"]] = Ah[["NonBurned", "Burned", "Harvested", "Hour"]].groupby('Hour')[["NonBurned", "Burned"]].max()

            #SummaryDF[["MinNonBurned", "MinBurned"]] = Ah[["NonBurned", "Burned", "Harvested", "Hour"]].groupby('Hour')["NonBurned", "Burned"].min()[["NonBurned", "Burned"]]
            SummaryDF[["MinNonBurned", "MinBurned"]] = Ah[["NonBurned", "Burned", "Harvested", "Hour"]].groupby('Hour')[["NonBurned", "Burned"]].min()
